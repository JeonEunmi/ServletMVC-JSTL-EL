	...
	$(document).ready(function() {
		...
		$(".btnDel").on("click", function() {
			...
			if (confirm(txt)) {
				...
				//->요청 주소 및 쿼리 문자열 사용
				window.location.assign("member/delete?mid_="+$(this).val());
			}
		});
		...
		$(".btnUp").on("click", function() {
			...
			$("#input form").attr("action", "member/update");
	...
	<div class="container">
		...
		<div class="panel page-header" style="text-align: center;">
			<h1 style="font-size: xx-large;">
				...
				<a href="${pageContext.request.contextPath}/member/list"> <img src="${pageContext.request.contextPath}/resources/img/sist_logo.png"
